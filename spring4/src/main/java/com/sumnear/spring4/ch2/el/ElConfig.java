package com.sumnear.spring4.ch2.el;
...
@Configuration
@ComponentScan("com.sumnear.spring4.ch2.el")
@PropertySource("classpath:com/sumnear/spring4/ch2/el/test.properties")//7
public class ElConfig
{
    ...
    @Value("classpath:com/sumnear/spring4/ch2/el/test.txt") //5
